...
async function buildAgendaDisplayPayload(
  ...
  resolveAt: Date,
      ...
      const publicConfig = {
        ...
        showCompany: config.showCompany ?? config.showPresenter ?? true,
        showPresenterCompany: config.showPresenterCompany ?? false,
        ...
        presenterCompanyColor: config.presenterCompanyColor ?? null,
      ...
      const publicItems = items.map((it) => ({
        ...
        presenterCompany: it.presenterCompany ?? null,
