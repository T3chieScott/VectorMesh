...
export async function registerRoutes(
  ...
  // ============ CUSTOMER-DATA ADMIN ROUTES (display profiles, screen
  // groups, programmes, screen presets) — extracted to server/customerDataRoutes.ts
  // (Task #258) so the tenant boundary can be exercised in isolation.
