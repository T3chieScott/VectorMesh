...
export const zoneTypeEnum = pgEnum("zone_type", ["media", "ticker", "clock", "logo", "html", "weather", "news", "montage", "qrcode", "countdown", "shape", "schedule", "media_player", "football_table", "heathrow_arrivals", "heathrow_departures", "weather_forecast"]);
...
export interface LayoutZone {
  id: string;
  name: string;
  type: "media" | "ticker" | "clock" | "logo" | "html" | "weather" | "news" | "text" | "shader" | "montage" | "qrcode" | "countdown" | "shape" | "schedule" | "media_player" | "football_table" | "heathrow_arrivals" | "heathrow_departures" | "weather_forecast";
  x: number;
  y: number;
  width: number;
  height: number;
